...
Если у вас не установлен язык программирования Golang, [скачайте и устновите](https://golang.org/doc/install) язык программирования Go. 
...
Если вы хотите удалить данные в личный чат с ботом напишити комманду:
```
...
И восстановаить данный с помощью команды **/recover**.
